 ...
 */
package com.stagemont.controller.job;

import com.stagemont.entities.Job;
import com.stagemont.source.job.JobFakeData;
...
public class JobList extends HttpServlet {
    ...
    private final JobSource DATA_SOURCE = new JobFakeData();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Job> listJob = DATA_SOURCE.getAllJob();
