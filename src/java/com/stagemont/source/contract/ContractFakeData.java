...
public class ContractFakeData implements ContractSource{
    ...
    public List<Contract> getAllContract() {
        ...
        Contract contract1 = new Contract((new Date(2021,6,30)), (new Date(2021,8,30)), Status.SUBMIT, 1, 1);
        Contract contract2 = new Contract((new Date(2022,1,11)), (new Date(2021,2,22)), Status.INTERVIEW, 1, 2);
        Contract contract3 = new Contract((new Date(2000,5,05)), (new Date(2021,5,06)), Status.EMPLOY, 1, 3);
